...
public class UpdateRole extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        req.getRequestDispatcher("/WEB-INF/test_task_views/role/UpdateRole.jsp").forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        store.update(Integer.parseInt(req.getParameter("id")), new Role(Integer.parseInt(req.getParameter("new_id")), req.getParameter("new_role")));
